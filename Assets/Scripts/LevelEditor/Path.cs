...
public class Path {
    ...
    public Path(Vector2 centre, float initialSize = 15.0f)
    {
        points = new List<Vector2>
        {
            centre+ initialSize * Vector2.left,
            centre+(Vector2.left+ initialSize * Vector2.up)*.5f,
            centre + (Vector2.right+ initialSize * Vector2.down)*.5f,
            centre + initialSize * Vector2.right
        };
    }
    ...
    public void MovePointEvenly(int i, Vector2 deltaPos)
    {
        points[i] += deltaPos;
    }
